...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'yolov8n-seg.pt', help='initial weights path')
...
def main(opt):
    ...
    # Use the model
    model.train(data=opt.data, epochs=5, batch=opt.batch, imgsz=640, project=opt.project, save_dir=os.environ.get("SM_MODEL_DIR"))
